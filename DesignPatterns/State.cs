...
namespace CRUDWebApp.DesignPatterns
{
    ...
    class Steak
    {
        ...
        public void AddTemp(double amount)
        {
            ...
            Debug.WriteLine("Increased temperature by {0} degrees.", amount);
            Debug.WriteLine(" Current temp is {0}", CurrentTemp);
            Debug.WriteLine(" Status is {0}", State.GetType().Name);
            Debug.WriteLine("");
        }
        ...
        public void RemoveTemp(double amount)
        {
            ...
            Debug.WriteLine("Decreased temperature by {0} degrees.", amount);
            Debug.WriteLine(" Current temp is {0}", CurrentTemp);
            Debug.WriteLine(" Status is {0}", State.GetType().Name);
            Debug.WriteLine("");
        }
